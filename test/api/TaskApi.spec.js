...
(function(root, factory) {
  ...
  describe('TaskApi', function() {
    ...
    describe('getAlltask', function() {
      it('should call getAlltask successfully', function(done) {
        //uncomment below and update the code to test getAlltask
        //instance.getAlltask(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
